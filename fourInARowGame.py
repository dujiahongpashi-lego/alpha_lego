...
b = Checkerboard()
g = Game()
# print(b.placeChequer(4, 0, 0, 0))
# print(b.placeChequer(8, 1, 0, 0))
# print(b.placeChequer(4, 0, 3, 1))
# print(b.placeChequer(8, 0, 3, 2))
# print(b.placeChequer(4, 0, 2, 1))
# print(b.judge())
# b.placeChequer(4, 0, 0, 0)
# b.judge()
# b.placeChequer(4, 0, 1, 1)
# b.judge()
# b.placeChequer(4, 0, 2, 2)
# b.judge()
# b.placeChequer(4, 0, 3, 4)
# b.judge()
# b.placeChequer(4, 0, 4, 4)
# b.judge()
# b.placeChequer(4, 0, 1, 2)
# b.judge()
# b.placeChequer(4, 0, 3, 2)
# b.judge()
# b.placeChequer(4, 0, 3, 4)
# b.judge()
# b.placeChequer(4, 0, 4, 1)
# b.judge()
# b.placeChequer(4, 0, 0, 2)
# b.judge()
# b.placeChequer(4, 0, 0, 1)
# b.judge()
# b.placeChequer(4, 0, 0, 3)
# b.judge()
# b.draw()
# print(b._judgeContinuousSame([0, 0, 0, 0, 1]))
# print(b._judgeContinuousSame([1, 2, 1, 2, 2]))
# print(b._judgeContinuousSame([1, 0, 1, 1, 1]))
# print(b._judgeContinuousSame([1, 1, 1, 1, 1]))
# print(b._judgeContinuousSame([1, 1, 2, 1, 1]))
# print(b._judgeContinuousSame([2, 1, 1, 1, 1]))
# print(b._judgeContinuousSame([1, 1, 1, 1, 2]))
...
# g.place(3, 1)
# g.draw()
# print('The Score', g._scence_score(g.board, 1))
# print('The Score', g._scence_score(g.board, 2))
# g.place(3, 1)
# g.place(3, 2)
# g.place(3, 2)
# g.place(3, 2)
...
# line = [0,1,1,1,1]
# print(line , b._line_situation(line, 1))
# line = [0,1,1,1,0]
# print(line , b._line_situation(line, 1))
# line = [0,0,1,1,1]
# print(line , b._line_situation(line, 1))
...
# print('Advice', g.nextColor, g.get_advice())
# g.place(2, 2)
# print('Advice', g.nextColor, g.get_advice())
# g.place(2, 1)
# print('Advice', g.nextColor, g.get_advice())
...
#     print('step', i, 'Advice', g.nextColor, 'at (', x, ',', y, ')')
#     win = g.place(x, y)
